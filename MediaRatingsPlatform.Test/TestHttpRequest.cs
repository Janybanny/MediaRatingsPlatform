...
public class TestHttpRequest
{
    ...
    public void TestValidCreateHttpRequest()
    {
        ...
        request.Headers.Returns(new NameValueCollection() {{"Authorization", "Bearer testtoken"}, {"testkey", "testvalue"}});
        byte[] byteArray = Encoding.ASCII.GetBytes( "TESTBODY" );
        ...
        Assert.That(result.Method, Is.EqualTo(PresentationLayer.HttpMethod.Get));
        Assert.That(result.Body, Is.EqualTo("TESTBODY"));
        Assert.That(result.Headers, Is.EqualTo(new Dictionary<string,string>{{"Authorization", "Bearer testtoken"}, {"testkey", "testvalue"}}));
    ...
    public void TestEdgeCaseCreateHttpRequest()
    {
        ...
        Assert.That(result.Headers, Is.EqualTo(new Dictionary<string,string>{{"Authorization", "Bearrer testtoken"}}));
